...
-   Support government workers in harmonizing their data sets according to the standards of opendata.swiss

    -   Data harmonization algorithms can aid in: \
         1. Cleansing and deduplicating data

    -   2\. Validating information

    -   3\. Ensuring high-quality, reliable data
...
4.  Demonstrate how clean the data would be if your tool had been used
